...
export default class TblVariablesEspecificas extends BaseSchema {
  ...
  public async up () {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.uuid('vre_maestra_id').references('emp_id').inTable('tbl_maestras')
      table.uuid('vre_usuario_id').references('emp_id').inTable('tbl_usuarios_empresas')
